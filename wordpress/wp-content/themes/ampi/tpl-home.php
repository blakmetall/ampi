...
<div class="container">
    <!-- title -->
    <h1 class="mb-4 font-weight-bold app-font-41">Real Estate in Bahía de Banderas</h1>
    ...
    <div class="card-deck">
        <div class="card border-0 app-card-1">
            ...
            <h2 class="font-weight-bold mb-3 app-font-24">Buying a property</h2>
...
<div class="app-home-form">
    ...
    <div class="container">
        <!-- title -->
        <h2 class="mb-4-2 font-weight-bold h1 app-font-41">Search for a Property</h2>
...
<div class="container">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h1 class="mb-0 font-weight-bold app-font-36">Latest News</h1>
